        ...
        <div>
            ...
            <div className='frontPictures'>
                <div className='image-grid image-grid2'>
                    ...
                    <img className='image imageSide1' src={images[12].media_url} />
                </div>
                <div className='image-grid image-grid3'>
                    <img className='image image2' src={images[8].media_url} />
                    <img className='image image2' src={images[5].media_url} />
                    <img className='image image2' src={images[15].media_url} />
                    <img className='image image2' src={images[13].media_url} />
                </div>
                <div className='image-grid image-grid4'>
                    <img className='image imageSide2' src={images[2].media_url} />
                    <img className='image image2' src={images[9].media_url} />
                    <img className='image image2' src={images[16].media_url} />
                    <img className='image imageSide3' src={images[14].media_url} />
                </div>
            </div>
        </div>
    )
